...
public class Bishop extends Piece {
    public Bishop(PieceCoordinate pieceCoordinate, Player player) {
        super(pieceCoordinate, player);
    }

    public Bishop(HorizontalBoardNotation horizontalBoardNotation, VerticalBoardNotation verticalBoardNotation, Player player) {
